...
const translations = {
    ko: {
        ...
        guideStep4: '이미지는 저작권 이슈로 첨부 하지 않았습니다. N 상세 정보를 이용해 주세요.',
    ...
    en: {
        ...
        guideStep4: 'Images are omitted due to copyright. Use the N details link on each card.',
    ...
    jp: {
        ...
        guideStep4: '画像は著作権上の理由で掲載していません。カード内のN詳細情報をご利用ください。',
    ...
    cn: {
        ...
        guideStep4: '图片因版权原因未附上。请使用卡片中的 N 详细信息。',
    ...
    th: {
        ...
        guideStep4: 'ไม่ได้แนบรูปภาพเนื่องจากลิขสิทธิ์ กรุณาใช้ N รายละเอียดบนการ์ด',
    ...
    ar: {
        ...
        guideStep4: 'لم نرفق الصور بسبب حقوق النشر. استخدم N التفاصيل في البطاقة.',
    ...
    fr: {
        ...
        guideStep4: 'Les images ne sont pas incluses pour des raisons de droits d’auteur. Utilisez le lien N détails sur la carte.',
    ...
    ru: {
        ...
        guideStep4: 'Изображения не добавлены из-за авторских прав. Используйте N подробности на карточке.',
