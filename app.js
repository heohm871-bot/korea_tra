...
const translations = {
    ko: {
        ...
        guideImageNotice: '이용 가이드의 이미지는 저작권 이슈로 첨부하지 않았습니다. 자세한 정보는 카드에 제시된 N 상세 정보를 이용해 주세요.',
    ...
    en: {
        ...
        guideImageNotice: 'Guide images are omitted due to copyright. For details, use the N details link shown on each card.',
    ...
    jp: {
        ...
        guideImageNotice: '利用ガイドの画像は著作権上の理由で掲載していません。詳細はカード内のN詳細情報をご利用ください。',
    ...
    cn: {
        ...
        guideImageNotice: '使用指南中的图片因版权原因未附上。详细信息请使用卡片中的 N 详细信息。',
    ...
    th: {
        ...
        guideImageNotice: 'ไม่ได้แนบรูปภาพในคู่มือการใช้งานเนื่องจากลิขสิทธิ์ กรุณาดูรายละเอียดจาก N รายละเอียดบนการ์ด',
    ...
    ar: {
        ...
        guideImageNotice: 'لم نرفق صور دليل الاستخدام بسبب حقوق النشر. للمزيد من المعلومات استخدم N التفاصيل في البطاقة.',
    ...
    fr: {
        ...
        guideImageNotice: 'Les images du guide ne sont pas incluses pour des raisons de droits d’auteur. Pour plus de détails, utilisez le lien N détails sur la carte.',
    ...
    ru: {
        ...
        guideImageNotice: 'Изображения в руководстве не добавлены из-за авторских прав. Подробности смотрите через N подробности на карточке.',
